...
export default function BenchmarkPage() {
  return (
    <div className="min-h-screen bg-[#F4EDE4] p-4 sm:p-8">
      <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl bg-white shadow-xl">
        <header className="border-b border-[#2D5F5D]/10 bg-white p-6 sm:p-8">
          ...
          <h1 className="mt-6 text-3xl font-black text-slate-900 sm:text-4xl">文獻基準驗證 (Benchmark Validation)</h1>
